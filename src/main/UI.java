...
//			currentDialogue = npc.dialogues[npc.dialogueSet][npc.dialogueIndex];
	...
	public void options_top(int frameX, int frameY) {
		...
		if(gp.fullScreenOn == true) {
			g2.fillRect(textX+5, textY+5, 16, 16);
		}
		...
		g2.fillRect(textX+5, textY+5, volumeWidth, 16);
		//SE slider
		textY += gp.tileSize;
		g2.drawRect(textX, textY, 120, 24);
	...
	public void options_control(int frameX, int frameY) {
		...
		g2.drawString("Pause/Options", textX, textY); textY += gp.tileSize;
		
		textX = frameX + gp.tileSize*6;
		textY = frameY + gp.tileSize*2;
		g2.drawString("WASD", textX, textY); textY += gp.tileSize;
		g2.drawString("SPACE", textX, textY); textY += gp.tileSize;
		g2.drawString("LMB", textX, textY); textY += gp.tileSize;
